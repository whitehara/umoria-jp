        ...
        switch ((PotionSpellTypes) potion_id) {
            case PotionSpellTypes::Strength:
                if (playerStatRandomIncrease(PlayerAttr::A_STR)) {
                    printMessage(_("Wow!  What bulging muscles!"));
                    identified = true;
                }
                break;
            ...
            case PotionSpellTypes::RestoreIntelligence:
                if (playerStatRestore(PlayerAttr::A_INT)) {
                    printMessage(_("You have have a warm feeling."));
                    identified = true;
                }
                break;
            case PotionSpellTypes::Wisdom:
                if (playerStatRandomIncrease(PlayerAttr::A_WIS)) {
                    printMessage(_("You suddenly have a profound thought!"));
                    identified = true;
                }
                break;
            ...
            case PotionSpellTypes::RestoreWisdom:
                if (playerStatRestore(PlayerAttr::A_WIS)) {
                    printMessage(_("You feel your wisdom returning."));
                    identified = true;
                }
                break;
            case PotionSpellTypes::Charisma:
                if (playerStatRandomIncrease(PlayerAttr::A_CHR)) {
                    printMessage(_("Gee, ain't you cute!"));
                    identified = true;
                }
                break;
            ...
            case PotionSpellTypes::RestoreCharisma:
                if (playerStatRestore(PlayerAttr::A_CHR)) {
                    printMessage(_("You feel your looks returning."));
                    identified = true;
                }
                break;
            ...
            case PotionSpellTypes::Constitution:
                if (playerStatRandomIncrease(PlayerAttr::A_CON)) {
                    printMessage(_("You feel tingly for a moment."));
                    identified = true;
                }
                break;
            case PotionSpellTypes::GainExperience:
                if (py.misc.exp < config::player::PLAYER_MAX_EXP) {
                    ...
                    printMessage(_("You feel more experienced."));
            ...
            case PotionSpellTypes::Blindness:
                if (py.flags.blind == 0) {
                    printMessage(_("You are covered by a veil of darkness."));
                    identified = true;
                }
            ...
            case PotionSpellTypes::Confusion:
                if (py.flags.confused == 0) {
                    printMessage(_("Hey!  This is good stuff!  * Hick! *"));
                    identified = true;
                }
            ...
            case PotionSpellTypes::LoseExperience:
                if (py.misc.exp > 0) {
                    printMessage(_("You feel your memories fade."));
            ...
            case PotionSpellTypes::SaltWater:
                ...
                printMessage(_("The potion makes you vomit!"));
                identified = true;
                break;
            ...
            case PotionSpellTypes::RestoreMana:
                if (py.misc.current_mana < py.misc.mana) {
                    ...
                    printMessage(_("Your feel your head clear."));
            ...
            case PotionSpellTypes::InfraVision:
                if (py.flags.timed_infra == 0) {
                    printMessage(_("Your eyes begin to tingle."));
                    identified = true;
                }
            ...
            default:
                ...
                printMessage(_("Internal error in potion()"));
                break;
        }
    }
...
void quaff() {
    ...
    if (py.pack.unique_items == 0) {
        printMessage(_("But you are not carrying anything."));
        return;
    }

    int item_pos_begin, item_pos_end;
    if (!inventoryFindRange(TV_POTION1, TV_POTION2, item_pos_begin, item_pos_end)) {
        printMessage(_("You are not carrying any potions."));
        return;
    }

    int item_id;
    if (!inventoryGetInputForItemId(item_id, _("Quaff which potion?"), item_pos_begin, item_pos_end, CNIL, CNIL)) {
        return;
    }
    ...
    if (item->flags == 0) {
        printMessage(_("You feel less thirsty."));
        identified = true;
    } else {
