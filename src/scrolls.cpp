...
static bool playerCanReadScroll(int &item_pos_start, int &item_pos_end) {
    if (py.flags.blind > 0) {
        printMessage(_("You can't see to read the scroll."));
        return false;
    }
    ...
    if (py.flags.confused > 0) {
        printMessage(_("You are too confused to read a scroll."));
        return false;
    }
    ...
    if (!inventoryFindRange(TV_SCROLL1, TV_SCROLL2, item_pos_start, item_pos_end)) {
        printMessage(_("You are not carrying any scrolls!"));
        return false;
    }
...
static bool scrollEnchantWeaponToHit() {
    ...
    (void) snprintf(msg, MORIA_OBJ_DESC_SIZE, _("Your %s glows faintly!"), desc);
    printMessage(msg);
    ...
    if (spellEnchantItem(item.to_hit, 10)) {
        ...
        printMessage(_("The enchantment fails."));
    }
...
static int scrollIdentifyItem(int item_id, bool &is_used_up) {
    printMessage(_("This is an identify scroll."));
...
static bool scrollRemoveCurse() {
    if (spellRemoveCurseFromAllWornItems()) {
        printMessage(_("You feel as if someone is watching over you."));
        return true;
    }
    return false;
}
...
static bool scrollConfuseMonster() {
    if (!py.flags.confuse_monster) {
        printMessage(_("Your hands begin to glow."));
...
static bool scrollEnchantWeapon() {
    ...
    (void) snprintf(msg, MORIA_OBJ_DESC_SIZE, _("Your %s glows brightly!"), desc);
    printMessage(msg);
...
static bool scrollCurseWeapon() {
    ...
    (void) snprintf(msg, MORIA_OBJ_DESC_SIZE, _("Your %s glows black, fades."), desc);
    printMessage(msg);
...
static void scrollWordOfRecall() {
    ...
    printMessage(_("The air about you becomes charged."));
}
...
void scrollRead() {
    ...
    int item_id;
    if (!inventoryGetInputForItemId(item_id, _("Read which scroll?"), item_pos_start, item_pos_end, CNIL, CNIL)) {
        return;
    }
    ...
    while (item_flags != 0) {
        ...
        switch (scroll_type) {
            ...
            case 18:
                ...
                break;
            case 19:
                printMessage(_("This is a mass genocide scroll."));
            ...
            case 20:
                ...
                break;
            case 21:
                printMessage(_("There is a high pitched humming noise."));
            ...
            case 24:
                ...
                break;
            case 25:
                printMessage(_("This is a Recharge-Item scroll."));
                used_up = spellRechargeItem(60);
                identified = true;
                break;
            case 26:
                printMessage(_("This is a genocide scroll."));
                (void) spellGenocide();
                identified = true;
                break;
            case 27:
            ...
            case 42:
                ...
                break;
            default:
                printMessage(_("Internal error in scroll()"));
                break;
        }
    }
