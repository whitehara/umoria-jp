...
namespace config {
    ...
    // i18n: currently active language code (e.g. "en", "ja"). Set once at
    // startup by lang::loadCatalog(), after resolving it via
    // lang::resolveLanguage(). Defaults to "en" (no translation catalog,
    // no localized data file lookups).
    namespace language {
